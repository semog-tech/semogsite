...
export async function WhatsAppFloat() {
  ...
  return (
    <a
      className="wa-float"
      // Opt-in na altura da barra de consentimento: o `CookieBanner` escreve
      // `--consent-bar-h` aqui enquanto ela está no ar, e o `bottom` em
      // `theme.css` soma essa altura para o botão não ficar sob o cartão.
      data-consent-offset=""
