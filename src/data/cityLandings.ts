...
export const CITY_LANDINGS: Record<string, CityLandingData> = {
  ...
  'joao-pessoa': {
    ...
    localContext:
      'Uma das capitais que mais crescem no Nordeste, João Pessoa vive um forte adensamento no litoral — Manaíra, Cabo Branco, Tambaú e Bessa — com condomínios cada vez mais verticais e exigentes em gestão. A Semog leva à Paraíba a mesma estrutura que construiu em 35 anos no Recife: prestação de contas 100% digital, aplicativo para moradores e uma equipe pessoense que resolve perto de você. Seja na orla ou em bairros em expansão como Altiplano e Bancários, o seu condomínio conta com gestão local de ponta a ponta.',
    coverageText:
  ...
  'campina-grande': {
    ...
    localContext:
      'Rainha da Borborema e principal polo tecnológico e universitário do interior nordestino, Campina Grande combina tradição e inovação — e o mesmo vale para a gestão de condomínios. Do Catolé ao Mirante e ao Alto Branco, o mercado condominial cresce junto com a cidade, e a Semog atende com tecnologia própria e um atendimento próximo, no jeito campinense. Aqui você tem a estrutura de uma administradora com 35 anos e mais de 650 condomínios sem abrir mão da proximidade que o interior valoriza.',
    coverageText:
  ...
  belem: {
    ...
    heroSubhead:
      'A força de uma administradora com 35 anos e mais de 650 condomínios, agora no coração da Amazônia: tecnologia, transparência e equipe local.',
    localContext:
      'No coração da Amazônia, Belém une o charme histórico da Cidade Velha e do Ver-o-Peso à verticalização acelerada de Umarizal, Nazaré e Batista Campos. Levar uma gestão condominial moderna à capital paraense é a missão da Semog no Norte: tecnologia que ainda era rara por aqui, prestação de contas transparente e uma equipe local que entende as particularidades do clima e do mercado amazônico. Do edifício histórico ao lançamento de alto padrão, seu condomínio ganha a estrutura de quem administra mais de 650 condomínios há 35 anos.',
    coverageText:
