...
readingTime: 11
meta:
  title: "Previsão orçamentária: o guia do síndico antes da assembleia"
  description: "Como montar um orçamento que passa na assembleia sem cortes cegos e sem susto no meio do ano. O passo a passo que usamos."
keyTakeaways:
  - "Separe despesa recorrente de investimento pontual antes de projetar qualquer número."
  - "Mapeie reajustes de contrato e dissídio num calendário — quase nada é surpresa."
  - "Trate o fundo de reserva como linha fixa do orçamento, não como sobra de caixa."
  - "Leve a assembleia cada aumento com uma explicação de uma linha: contrato e data."
---
