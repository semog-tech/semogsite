...
readingTime: 10
meta:
  title: "Assembleia de instalação: checklist do condomínio novo"
  description: "Da convocação dos compradores ao CNPJ, tudo o que precisa acontecer na ordem certa para o condomínio nascer pronto para funcionar."
keyTakeaways:
