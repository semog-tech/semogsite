...
readingTime: 7
meta:
  title: "Fundo de reserva: quanto guardar por mês, na prática"
  description: "A conta que evita rateio extra: os percentuais praticados, o que a convenção pode exigir e quando o fundo pode ser usado."
keyTakeaways:
