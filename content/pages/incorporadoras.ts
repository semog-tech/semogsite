    ...
    // verbatim do ref (viewBox 24x24).
    {
      ...
      items: [
        ...
        },
        {
          ...
          text: 'Coordenamos, com escritório de advocacia parceiro, a elaboração da convenção, do regimento interno e da estrutura jurídica adequados ao perfil do empreendimento, prontos para registro e alinhados ao memorial de incorporação.',
          tags: [{ label: 'Suporte jurídico com parceiro' }, { label: 'Registro em cartório' }],
        },
        {
          iconSvg:
